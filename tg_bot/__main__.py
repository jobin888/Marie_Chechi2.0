...
PM_START_TEXT = """
ഹായ് {m.from_user.mention}, എന്റെ പേര് {}! എന്നെ ഉപയോഗിക്കേണ്ടത് എങ്ങനെ ആണെന്നുള്ളതിൽ എന്തേലും സംശയം ഉണ്ടെങ്കിൽ /help കൊടുത്താൽ മതിയാകും... 
എന്റെ ന്യൂ ഫീച്ചേർസ് ചാനലിൽ @NT_BOT_CHANNEL ഇടുന്നതായിരിക്കും. സംശയങ്ങൾക്ക് @Ntbotgroup എന്ന ഗ്രൂപ്പിൽ വരാവുന്നതാണ്.....
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("എന്താണ് 🤨")
